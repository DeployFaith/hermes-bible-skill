...
| How SOUL.md works now | `/docs/user-guide/features/personality` |
...
| Kanban (Multi-Agent Board) | `/docs/user-guide/features/kanban` |
| Kanban tutorial | `/docs/user-guide/features/kanban-tutorial` |
| Persistent Goals | `/docs/user-guide/features/goals` |
...
| Vision & Image Paste | `/docs/user-guide/features/vision` |
...
| Codex App-Server Runtime | `/docs/user-guide/features/codex-app-server-runtime` |
| Computer Use (macOS) | `/docs/user-guide/features/computer-use` |
| Deliverable Mode | `/docs/user-guide/features/deliverable-mode` |
| Extending the Dashboard | `/docs/user-guide/features/extending-the-dashboard` |
| Kanban worker lanes | `/docs/user-guide/features/kanban-worker-lanes` |
| LSP — Semantic Diagnostics | `/docs/user-guide/features/lsp` |
| Skins & Themes | `/docs/user-guide/features/skins` |
| Spotify | `/docs/user-guide/features/spotify` |
| Subscription Proxy | `/docs/user-guide/features/subscription-proxy` |
| Nous Tool Gateway | `/docs/user-guide/features/tool-gateway` |
| Tool Search | `/docs/user-guide/features/tool-search` |
| Web Dashboard | `/docs/user-guide/features/web-dashboard` |
| Web Search & Extract | `/docs/user-guide/features/web-search` |
| X (Twitter) Search | `/docs/user-guide/features/x-search` |

## Messaging Platforms (30 pages)
...
| QQ Bot | `/docs/user-guide/messaging/qqbot` |
